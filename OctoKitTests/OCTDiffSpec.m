...
it(@"should initialize", ^{
    expect(diffEntry.blobSHA).to.equal(representation[@"sha"]);
    expect(diffEntry.filename).to.equal(representation[@"filename"]);
    expect(diffEntry.status).to.equal(representation[@"status"]);
    expect(diffEntry.additions).to.equal(representation[@"additions"]);
    expect(diffEntry.deletions).to.equal(representation[@"deletions"]);
    expect(diffEntry.changes).to.equal(representation[@"changes"]);
